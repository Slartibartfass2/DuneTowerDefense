...
//        var settingsButton = new VisTextButton("Settings");
        ...
        float padHorizontal = PixelsConverter.getX(PADDING_HORIZONTAL);
        float padVertical = PixelsConverter.getY(PADDING_VERTICAL);
        float spacing = PixelsConverter.getY(SPACING);
